...
cp -r .config .fonts.conf .git .gitignore .gvimrc INSTALL INSTALL_NO_GIT readme.md .vim .vimrc .zshrc $HOME/
...
if [ -x '/usr/bin/gconftool-2' ]; then
  echo "Changing gnome-terminal colour scheme."
