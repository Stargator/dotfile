...
" Minor tweaks by Kelsey Judson (kelseyjudson@gmail.com)
" Original source - squil/vim_colors (github).
...
if exists("syntax_on")
  ...
  hi CursorLine  guifg=NONE guibg=#a7d9e2 gui=NONE
  hi CursorColumn  guifg=NONE guibg=#a7d9e2 gui=NONE
  ...
  hi SpecialKey  guifg=#3592a8 guibg=#a7d9e2 gui=NONE
